...
# 		net.load_state_dict(torch.load(mdl_file))
	...
	for epoch in range(1000):
		...
		mini = MiniImagenet('/home/atik/Documents/Relation Network/LearningToCompare_FSL/datas/Ocast/', 
		...
		mini_val = MiniImagenet('/home/atik/Documents/Relation Network/LearningToCompare_FSL/datas/Ocast/', 
                          mode='val', n_way=n_way, k_shot=k_shot, k_query=k_query,
